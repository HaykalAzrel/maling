...
export function DeviceDetailPage() {
  ...
  if (loading && !device) {
    return (
      <div className="min-h-dvh bg-background px-4 flex items-center justify-center text-muted-foreground text-center">
      ...
      <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
        <div className="py-6 sm:py-8 lg:py-10 space-y-6 lg:space-y-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5">
            <button onClick={() => navigate("/devices")} className="p-2 hover:bg-accent rounded-xl transition-colors self-start">
            ...
            <div className={`px-3 py-1.5 rounded-lg text-sm self-start ${
          ...
          <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
              ...
              <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr] xl:items-center">
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="text-4xl sm:text-5xl mb-2 break-words">
                ...
                <div className="relative mx-auto w-full max-w-[360px] aspect-[280/240] rounded-3xl bg-[#0d1320] border border-white/10 shadow-[0_0_50px_rgba(79,124,255,0.12)] overflow-hidden">
                ...
                <div className="space-y-3 xl:col-span-2">
                  ...
                  <div className="h-56 sm:h-64 w-full rounded-2xl border border-border bg-background/60 p-3">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={chartData}>
                        ...
                        <Tooltip
                          contentStyle={{ background: "#141824", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px" }}
            ...
            <div className="space-y-6">
              ...
              {/* Schedule Automation */}
              <div className="bg-card/95 border border-border rounded-2xl p-4 sm:p-6 shadow-sm backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between rounded-xl border border-border bg-background/70 px-4 py-3 mb-4 gap-4">
                  <span className="text-sm text-muted-foreground">Automation status</span>
                  <span className={`text-sm text-right ${isScheduleActive ? "text-status-safe" : "text-muted-foreground"}`}>
                    {scheduleStatusLabel}
                  </span>
                </div>
                {scheduleEnabled && (
