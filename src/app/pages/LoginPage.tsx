      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-input-background border border-border rounded-xl px-12 py-3 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              />
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-input-background border border-border py-3 rounded-xl hover:bg-accent transition-all flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:opacity-70"
          >
