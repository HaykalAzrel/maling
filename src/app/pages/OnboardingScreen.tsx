        ...
        <AnimatePresence mode="wait">
          ...
          >
            <motion.div
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
              className="w-48 h-48 mx-auto mb-12 bg-primary/10 rounded-3xl flex items-center justify-center border border-primary/20"
            >
              {(() => {
                const IconComponent = slides[currentSlide].icon;
                return IconComponent ? <IconComponent className="w-24 h-24 text-primary" /> : null;
              })()}
            </motion.div>
