...
import { refreshSessionStart } from "../App";
        ...
        {/* Power button — overlap navbar */}
          <div className="absolute left-1/2 -translate-x-1/2 -translate-y-1/4 top-0 z-50">
            <button
              ...
              className={`w-14 h-14 rounded-full flex items-center justify-center shadow-xl border-4 border-background transition-all ${
                isPowerEnabled
